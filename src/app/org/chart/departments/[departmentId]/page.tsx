/**
 * Legacy org chart department drill-in — redirects to workspace-scoped structure/departments/[departmentId].
 */
...
export default async function OldOrgChartDepartmentPage({ params }: PageProps) {
