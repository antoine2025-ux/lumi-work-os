 ...
 * 
 * Route: /org/workspace-settings
 * 
 * Workspace administration:
 * - Members (list, role management)
 * - Invites (pending invitations)
 * - General (workspace name, settings)
 * - Danger Zone (delete workspace)
 * 
 * Supports ?tab= query param for deep linking.
 */
...
export default async function WorkspaceSettingsPage() {
  ...
  return (
    <>
      <OrgPageViewTracker route="/org/workspace-settings" name="Workspace Settings" />
