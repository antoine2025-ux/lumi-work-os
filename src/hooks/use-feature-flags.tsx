...
interface FeatureFlags {
  ...
  // Org module feature flags (Phase 0: all default to false for safe merge)
  orgEnabled: boolean
  orgCapacityEnabled: boolean
  orgManagementLoadEnabled: boolean
  orgOwnershipEnabled: boolean
}
...
export function FeatureFlagProvider({ children }: { children: React.ReactNode }) {
  const [flags, setFlags] = useState<FeatureFlags>({
    ...
    // Org flags default to false for safe merge
    orgEnabled: false,
    orgCapacityEnabled: false,
    orgManagementLoadEnabled: false,
    orgOwnershipEnabled: false,
  })
